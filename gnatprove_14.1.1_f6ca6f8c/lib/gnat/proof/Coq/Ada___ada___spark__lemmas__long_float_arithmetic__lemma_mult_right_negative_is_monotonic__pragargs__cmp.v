...
Theorem def'vc :
  ...
  (((le (neg fliteral2) val1 /\ le val1 fl_last_sqrt) /\ (* non escaped EOL for cpp parsing *)
   ...
   le (neg fliteral2) val3 /\ le val3 fliteral3) /\ (* non escaped EOL for cpp parsing *)
  le val1 val2 -> le (mul RNE val2 val3) (mul RNE val1 val3).
Proof.
...
(* file shared by the two lemmas dealing 32/64-bit mult right monotonicity *)
