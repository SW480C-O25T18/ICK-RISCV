...
Theorem def'vc :
  ...
  Init.Datatypes.true Init.Datatypes.true ->
  dynamic_invariant1 factor Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  ult val1 val2 /\ ule val2 (udiv rliteral1 factor) ->
  ult (mul val1 factor) (mul val2 factor).
Proof.
...
assert (t'int val2 * t'int factor <= 18446744073709551615) as shared_lemma.
{
