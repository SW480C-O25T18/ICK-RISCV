...
Axiom nth_out_of_bound :
  forall (x:t) (n:Z), ((n < 0%Z)%Z \/ (64%Z <= n)%Z) -> ((nth x n) = false).
...
Axiom Nth_ones :
  forall (n:Z), ((0%Z <= n)%Z /\ (n < 64%Z)%Z) -> ((nth ones n) = true).

Parameter bw_and: t -> t -> t.

Axiom Nth_bw_and :
  forall (v1:t) (v2:t) (n:Z), ((0%Z <= n)%Z /\ (n < 64%Z)%Z) ->
...
Axiom Nth_bw_not :
  forall (v:t) (n:Z), ((0%Z <= n)%Z /\ (n < 64%Z)%Z) ->
...
Axiom Asr_nth_low :
  forall (b:t) (n:Z) (s:Z), (0%Z <= s)%Z -> ((0%Z <= n)%Z /\ (n < 64%Z)%Z) ->
  ((n + s)%Z < 64%Z)%Z -> ((nth (asr b s) n) = (nth b (n + s)%Z)).

Axiom Asr_nth_high :
  forall (b:t) (n:Z) (s:Z), (0%Z <= s)%Z -> ((0%Z <= n)%Z /\ (n < 64%Z)%Z) ->
  (64%Z <= (n + s)%Z)%Z -> ((nth (asr b s) n) = (nth b (64%Z - 1%Z)%Z)).
...
Axiom Lsl_nth_high :
  forall (b:t) (n:Z) (s:Z), ((0%Z <= s)%Z /\ ((s <= n)%Z /\ (n < 64%Z)%Z)) ->
...
Axiom Nth_rotate_right :
  forall (v:t) (n:Z) (i:Z), ((0%Z <= i)%Z /\ (i < 64%Z)%Z) -> (0%Z <= n)%Z ->
...
Axiom to_uint_of_int :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 18446744073709551616%Z)%Z) ->
  ((t'int (of_int i)) = i).
...
Axiom Nth_bv_is_nth2 :
  forall (x:t) (i:Z), ((0%Z <= i)%Z /\ (i < 18446744073709551616%Z)%Z) ->
...
Axiom bool_eq_def :
  forall (x:t) (y:t),
  ((x = y) -> ((bool_eq x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Axiom bool_ne_def :
  forall (x:t) (y:t),
  (~ (x = y) -> ((bool_ne x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Axiom bool_lt_def :
  forall (x:t) (y:t),
  ((ult x y) -> ((bool_lt x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Axiom bool_le_def :
  forall (x:t) (y:t),
  ((ule x y) -> ((bool_le x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Axiom bool_gt_def :
  forall (x:t) (y:t),
  ((ugt x y) -> ((bool_gt x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Axiom bool_ge_def :
  forall (x:t) (y:t),
  ((uge x y) -> ((bool_ge x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
Parameter bool_eq1: t -> t -> bool.

Axiom bool_eq_def1 :
  forall (x:t) (y:t),
  ((x = y) -> ((bool_eq1 x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
(* Why3 assumption *)
Definition uint__ref_uint__content__projection (a:uint__ref) : uint :=
  uint__content a.
...
(* Why3 assumption *)
Definition dynamic_invariant (temp___expr_165:t) (temp___is_init_161:bool)
...
Axiom bool_eq_def2 :
  forall (x:t) (y:t),
  ((x = y) -> ((bool_eq2 x y) = true)) /\ (* non escaped EOL for cpp parsing *)
...
(* Why3 assumption *)
Definition dynamic_invariant1 (temp___expr_172:t) (temp___is_init_168:bool)
    (temp___skip_constant_169:bool) (temp___do_toplevel_170:bool)
    (temp___do_typ_inv_171:bool) : Prop :=
  ((temp___is_init_168 = true) \/ (ule rliteral2 rliteral1)) ->
...
Theorem def'vc :
  ...
  (* pragma Assert (Res <= Arg1); -- MANUAL PROOF ^ spark-mod_arithmetic_lemmas.adb:50:22:instantiated:spark-mod64_arithmetic_lemmas.ads:33:1:VC_ASSERT *)
  (ule res arg1) ->
  (* pragma Assert (Arg1 - Res < Arg2); -- MANUAL PROOF ^ spark-mod_arithmetic_lemmas.adb:51:22:instantiated:spark-mod64_arithmetic_lemmas.ads:33:1:VC_ASSERT *)
...
assert (0 <= (t'int arg1 / t'int arg2) * t'int arg2 <
       ...
       18446744073709551616) as no_ovfl_div_mul.
split.
