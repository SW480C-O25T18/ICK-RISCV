...
Axiom t'axiom :
  forall (i:t),
  (0%Z <= (t'int i))%Z /\ ((t'int i) <= 18446744073709551615%Z)%Z.

Parameter nth: t -> Numbers.BinNums.Z -> Init.Datatypes.bool.

Axiom nth_out_of_bound :
  forall (x:t) (n:Numbers.BinNums.Z), (n < 0%Z)%Z \/ (64%Z <= n)%Z ->
...
Axiom Nth_bw_and :
  forall (v1:t) (v2:t) (n:Numbers.BinNums.Z), (0%Z <= n)%Z /\ (n < 64%Z)%Z ->
...
Axiom Nth_bw_not :
  forall (v:t) (n:Numbers.BinNums.Z), (0%Z <= n)%Z /\ (n < 64%Z)%Z ->
...
Axiom Lsr_nth_low :
  ...
  (0%Z <= n)%Z -> ((n + s)%Z < 64%Z)%Z ->
  ((nth (lsr b s) n) = (nth b (n + s)%Z)).

Axiom Lsr_nth_high :
  forall (b:t) (n:Numbers.BinNums.Z) (s:Numbers.BinNums.Z), (0%Z <= s)%Z ->
  (0%Z <= n)%Z -> (64%Z <= (n + s)%Z)%Z ->
...
Axiom Asr_nth_low :
  forall (b:t) (n:Numbers.BinNums.Z) (s:Numbers.BinNums.Z), (0%Z <= s)%Z ->
  (0%Z <= n)%Z /\ (n < 64%Z)%Z -> ((n + s)%Z < 64%Z)%Z ->
  ((nth (asr b s) n) = (nth b (n + s)%Z)).

Axiom Asr_nth_high :
  forall (b:t) (n:Numbers.BinNums.Z) (s:Numbers.BinNums.Z), (0%Z <= s)%Z ->
  (0%Z <= n)%Z /\ (n < 64%Z)%Z -> (64%Z <= (n + s)%Z)%Z ->
...
Axiom Nth_rotate_right :
  ...
  (0%Z <= i)%Z /\ (i < 64%Z)%Z -> (0%Z <= n)%Z ->
  ((nth (rotate_right v n) i) =
   (nth v (int.EuclideanDivision.mod1 (i + n)%Z 64%Z))).
...
Axiom to_int'def :
  ...
  (~ is_signed_positive x ->
   ((to_int x) = (-(18446744073709551616%Z - (t'int x))%Z)%Z)).
...
Axiom to_uint_bounds :
  forall (v:t),
  (0%Z <= (t'int v))%Z /\ ((t'int v) < 18446744073709551616%Z)%Z.

Axiom to_uint_of_int :
  forall (i:Numbers.BinNums.Z),
  (0%Z <= i)%Z /\ (i < 18446744073709551616%Z)%Z -> ((t'int (of_int i)) = i).

Parameter size_bv: t.

Axiom to_uint_size_bv : ((t'int size_bv) = 64%Z).

Axiom to_uint_zeros : ((t'int zeros) = 0%Z).

Axiom to_uint_one : ((t'int one) = 1%Z).

Axiom to_uint_ones : ((t'int ones) = 18446744073709551615%Z).
...
Axiom to_uint_add :
  forall (v1:t) (v2:t),
  ((t'int (add v1 v2)) =
   (int.EuclideanDivision.mod1 ((t'int v1) + (t'int v2))%Z
    18446744073709551616%Z)).

Axiom to_uint_add_bounded :
  forall (v1:t) (v2:t),
  (((t'int v1) + (t'int v2))%Z < 18446744073709551616%Z)%Z ->
...
Axiom to_uint_neg :
  forall (v:t),
  ((t'int (neg v)) =
   (int.EuclideanDivision.mod1 (-(t'int v))%Z 18446744073709551616%Z)).
...
Axiom unsigned_64 : Type.
Parameter unsigned_64_WhyType : WhyType unsigned_64.
Existing Instance unsigned_64_WhyType.
...
Parameter user_eq: unsigned_64 -> unsigned_64 -> Init.Datatypes.bool.

Parameter dummy: unsigned_64.

(* Why3 assumption *)
Inductive unsigned_64__ref :=
  | unsigned_64__ref'mk : unsigned_64 -> unsigned_64__ref.
Axiom unsigned_64__ref_WhyType : WhyType unsigned_64__ref.
Existing Instance unsigned_64__ref_WhyType.

(* Why3 assumption *)
Definition unsigned_64__content (v:unsigned_64__ref) : unsigned_64 :=
  match v with
  | unsigned_64__ref'mk x => x
  end.

(* Why3 assumption *)
Definition unsigned_64__ref_unsigned_64__content__projection
...
Axiom rliteral_axiom1 : ((t'int rliteral1) = 18446744073709551615%Z).
...
(* Why3 goal *)
Theorem def'vc :
  dynamic_invariant val__ Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  dynamic_invariant scale_num Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  dynamic_invariant1 scale_denom Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  dynamic_invariant res Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  (ule scale_num scale_denom /\ (* non escaped EOL for cpp parsing *)
   ((scale_num = rliteral) \/ ule val__ (udiv rliteral1 scale_num))) /\ (* non escaped EOL for cpp parsing *)
  (res = (udiv (mul val__ scale_num) scale_denom)) -> ule res val__.
Proof.
...
unfold ule in *.
rewrite rliteral_axiom in scale_denom_lb.
...
* rewrite BV_Gen.mod1_out.
  ...
  + split; [auto with zarith|].
    destruct mul_no_ovfl as [scale_num_zero|val_le_div].
      { rewrite scale_num_zero, rliteral_axiom2 in scale_num_not_zero by auto with zarith.
    ...
    replace (18446744073709551616) with (Z.succ 18446744073709551615) by auto with zarith.
    apply Zle_lt_succ.
    assert (0 < t'int scale_num) as scale_num_pos by auto with zarith.
    assert (0 <= 18446744073709551615) as uint_max_nat by auto with zarith.
