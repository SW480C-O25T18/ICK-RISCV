...
Axiom nth_out_of_bound :
  forall (x:t) (n:Z), ((n < 0%Z)%Z \/ (32%Z <= n)%Z) -> ((nth x n) = false).
...
Axiom Nth_ones :
  forall (n:Z), ((0%Z <= n)%Z /\ (n < 32%Z)%Z) -> ((nth ones n) = true).

Parameter bw_and: t -> t -> t.

Axiom Nth_bw_and :
  forall (v1:t) (v2:t) (n:Z), ((0%Z <= n)%Z /\ (n < 32%Z)%Z) ->
...
Axiom Nth_bw_not :
  forall (v:t) (n:Z), ((0%Z <= n)%Z /\ (n < 32%Z)%Z) ->
...
Axiom Asr_nth_low :
  forall (b:t) (n:Z) (s:Z), (0%Z <= s)%Z -> ((0%Z <= n)%Z /\ (n < 32%Z)%Z) ->
  ((n + s)%Z < 32%Z)%Z -> ((nth (asr b s) n) = (nth b (n + s)%Z)).

Axiom Asr_nth_high :
  forall (b:t) (n:Z) (s:Z), (0%Z <= s)%Z -> ((0%Z <= n)%Z /\ (n < 32%Z)%Z) ->
  (32%Z <= (n + s)%Z)%Z -> ((nth (asr b s) n) = (nth b (32%Z - 1%Z)%Z)).
...
Axiom Lsl_nth_high :
  forall (b:t) (n:Z) (s:Z), ((0%Z <= s)%Z /\ ((s <= n)%Z /\ (n < 32%Z)%Z)) ->
...
Axiom Nth_rotate_right :
  forall (v:t) (n:Z) (i:Z), ((0%Z <= i)%Z /\ (i < 32%Z)%Z) -> (0%Z <= n)%Z ->
...
Axiom to_uint_of_int :
  forall (i:Z), ((0%Z <= i)%Z /\ (i < 4294967296%Z)%Z) ->
  ((t'int (of_int i)) = i).
...
Axiom Nth_bv_is_nth2 :
  forall (x:t) (i:Z), ((0%Z <= i)%Z /\ (i < 4294967296%Z)%Z) ->
...
Theorem def'vc :
  ...
  (* pragma Assert (Res <= Arg1); -- MANUAL PROOF ^ spark-mod_arithmetic_lemmas.adb:50:22:instantiated:spark-mod32_arithmetic_lemmas.ads:33:1:VC_ASSERT *)
  (ule res arg1) ->
  (* pragma Assert (Arg1 - Res < Arg2); -- MANUAL PROOF ^ spark-mod_arithmetic_lemmas.adb:51:22:instantiated:spark-mod32_arithmetic_lemmas.ads:33:1:VC_ASSERT *)
