...
Theorem def'vc :
  ...
  Init.Datatypes.true Init.Datatypes.true ->
  dynamic_invariant upper_bound Init.Datatypes.true Init.Datatypes.false
  Init.Datatypes.true Init.Datatypes.true ->
  (arg2 = rliteral) \/ ule arg1 (udiv upper_bound arg2) ->
  ule (mul arg1 arg2) upper_bound.
Proof.
...
(* case arg2 is zero *)
* assert (0 <= t'int arg1 * t'int arg2 < 18446744073709551616) as zero_bound.
  rewrite arg2_zero, Z.mul_0_r.
  auto with zarith.
  pose (BV_Gen.mod1_out (t'int arg1 * t'int arg2) 18446744073709551616 zero_bound) as mul_in_bounds; clearbody mul_in_bounds.
