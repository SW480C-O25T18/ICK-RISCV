...
package body Arch.Context is
   ...
   begin
      ...
      -- Minimal inline assembly to restore context and jump to SEPC.
      ...
      -- sret shoud not return to this context;  add an infinite loop safeguard to prevent undetermined state.
      loop null; end loop;
   end Load_GP_Context;
   ...
   begin
      ...
      -- Clear unused portion of the FP context.
